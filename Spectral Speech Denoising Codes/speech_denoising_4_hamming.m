...
window=hamming(window_length); %create a hamming window in length of window_length. the input signal x will be divided into segments in length of window variable.
...
shading interp;
colormap('jet');
title('Spectrogram: speech + audience');
xlabel('Time (s)');
ylabel('Frequency (Hz)');
...
shading interp;
colormap('jet');
title('Hamming Windowed Spectrogram: speech only');
xlabel('Time (s)');
ylabel('Frequency (Hz)');
